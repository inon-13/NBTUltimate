...
execute as @e[type=marker] at @s run function nbtultimate:utilities/command_activate/command with entity @s data.PublicNBTUValues.RunCommand.tick.Functions[5]
execute as @e[type=marker] at @s run function nbtultimate:utilities/command_activate/command with entity @s data.PublicNBTUValues.RunCommand.tick.Functions[6]
execute as @e[type=marker] at @s run function nbtultimate:utilities/command_activate/command with entity @s data.PublicNBTUValues.RunCommand.tick.Functions[7]
execute as @e[type=marker] at @s run function nbtultimate:utilities/command_activate/command with entity @s data.PublicNBTUValues.RunCommand.tick.Functions[8]
execute as @e[type=marker] at @s run function nbtultimate:utilities/command_activate/command with entity @s data.PublicNBTUValues.RunCommand.tick.Functions[9]
...
execute as @e[type=marker] at @s run execute as @e[type=interaction,distance=..1] at @s on target run function nbtultimate:utilities/command_activate/command with entity @n[type=marker] data.PublicNBTUValues.RunCommand.RightClick.Functions[5]
execute as @e[type=marker] at @s run execute as @e[type=interaction,distance=..1] at @s on target run function nbtultimate:utilities/command_activate/command with entity @n[type=marker] data.PublicNBTUValues.RunCommand.RightClick.Functions[6]
execute as @e[type=marker] at @s run execute as @e[type=interaction,distance=..1] at @s on target run function nbtultimate:utilities/command_activate/command with entity @n[type=marker] data.PublicNBTUValues.RunCommand.RightClick.Functions[7]
execute as @e[type=marker] at @s run execute as @e[type=interaction,distance=..1] at @s on target run function nbtultimate:utilities/command_activate/command with entity @n[type=marker] data.PublicNBTUValues.RunCommand.RightClick.Functions[8]
execute as @e[type=marker] at @s run execute as @e[type=interaction,distance=..1] at @s on target run function nbtultimate:utilities/command_activate/command with entity @n[type=marker] data.PublicNBTUValues.RunCommand.RightClick.Functions[9]
...
execute as @e[type=marker] at @s run execute as @e[type=interaction,distance=..1] at @s on attacker run function nbtultimate:utilities/command_activate/command with entity @n[type=marker] data.PublicNBTUValues.RunCommand.attack.Functions[5]
execute as @e[type=marker] at @s run execute as @e[type=interaction,distance=..1] at @s on attacker run function nbtultimate:utilities/command_activate/command with entity @n[type=marker] data.PublicNBTUValues.RunCommand.attack.Functions[6]
execute as @e[type=marker] at @s run execute as @e[type=interaction,distance=..1] at @s on attacker run function nbtultimate:utilities/command_activate/command with entity @n[type=marker] data.PublicNBTUValues.RunCommand.attack.Functions[7]
execute as @e[type=marker] at @s run execute as @e[type=interaction,distance=..1] at @s on attacker run function nbtultimate:utilities/command_activate/command with entity @n[type=marker] data.PublicNBTUValues.RunCommand.attack.Functions[8]
execute as @e[type=marker] at @s run execute as @e[type=interaction,distance=..1] at @s on attacker run function nbtultimate:utilities/command_activate/command with entity @n[type=marker] data.PublicNBTUValues.RunCommand.attack.Functions[9]
