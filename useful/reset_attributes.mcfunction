...
# - Warning: This function is for players only!
...
attribute @s luck base set 0
attribute @s max_absorption base set 0
attribute @s mining_efficiency base set 0
attribute @s movement_efficiency base set 0
attribute @s oxygen_bonus base set 0
attribute @s sweeping_damage_ratio base set 0
attribute @s water_movement_efficiency base set 0
...
attribute @s movement_speed base set 0.10000000149011612