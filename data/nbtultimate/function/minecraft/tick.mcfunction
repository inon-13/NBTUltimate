...
clear @a[tag=!nbtu.BlockedItems.allow] #nbtultimate:blocked_items
...
execute as @e[type=#arrows] at @s run function nbtultimate:tick-functions/public_nbtu_values/run_command/tick_on_shot_entity/main
function nbtultimate:tick-functions/public_nbtu_values/block_uses/block_all_uses
function nbtultimate:tick-functions/public_nbtu_values/run_command/tick_on_item_entity/main
function nbtultimate:tick-functions/public_nbtu_values/run_command/tick/main
